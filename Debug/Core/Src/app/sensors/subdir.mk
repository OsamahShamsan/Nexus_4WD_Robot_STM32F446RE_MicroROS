...
clean-Core-2f-Src-2f-app-2f-sensors:
	-$(RM) ./Core/Src/app/sensors/current_sensor.cyclo ./Core/Src/app/sensors/current_sensor.d ./Core/Src/app/sensors/current_sensor.o ./Core/Src/app/sensors/current_sensor.su ./Core/Src/app/sensors/imu_interface.cyclo ./Core/Src/app/sensors/imu_interface.d ./Core/Src/app/sensors/imu_interface.o ./Core/Src/app/sensors/imu_interface.su ./Core/Src/app/sensors/ultrasonic_array.cyclo ./Core/Src/app/sensors/ultrasonic_array.d ./Core/Src/app/sensors/ultrasonic_array.o ./Core/Src/app/sensors/ultrasonic_array.su
